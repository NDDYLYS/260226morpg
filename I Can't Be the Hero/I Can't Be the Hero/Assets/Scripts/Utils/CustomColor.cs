...
public class CustomColor : MonoBehaviour
{
    ...
    public Color red = new Color(0.87890625f, 0.25f, 0.25f);

    public Color green = new Color(0.25f, 0.87890625f, 0.25f);

    public Color blue = new Color(0.25f, 0.25f, 0.87890625f);
